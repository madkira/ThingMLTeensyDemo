...
//Instance seriala
// Variables for the properties of the instance
struct Seriala_Instance seriala_var;
// Variables for the sessions of the instance
//Instance softButton
// Variables for the properties of the instance
...
Seriala_handle_basic_erreur(&seriala_var, param_id);
...
Communication_handle_Button_click(&communication_var);
...
// Init the ID, state variables and properties for instance seriala
seriala_var.active = true;
seriala_var.id_basic = add_instance( (void*) &seriala_var);
seriala_var.Seriala_Message_State = SERIALA_MESSAGE_IDLE_STATE;

Seriala_Message_OnEntry(SERIALA_MESSAGE_STATE, &seriala_var);
